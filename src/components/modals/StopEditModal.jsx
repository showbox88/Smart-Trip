      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '520px', maxHeight: '85vh', overflowY: 'auto' }}>
        ...
        <div className="form-group" style={{ marginBottom: '1.2rem' }}>
          ...
          <input
            ...
            style={{ width: '100%', padding: '0.8rem', background: 'transparent', border: '1px solid var(--glass-border)', borderRadius: '8px', color: 'var(--text-primary)', outline: 'none', fontSize: '1rem', boxSizing: 'border-box' }}
          />
        </div>
        ...
        <div className="form-group" style={{ marginBottom: '1.2rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
            ...
            <select
              value={form.period}
              onChange={set('period')}
              style={{ padding: '0.8rem', background: 'var(--bg-secondary)', border: '1px solid var(--glass-border)', borderRadius: '8px', color: 'var(--text-primary)', outline: 'none', cursor: 'pointer' }}
            >
        ...
        <div className="form-group" style={{ marginBottom: '1.5rem' }}>
          ...
          <textarea
            ...
            style={{ width: '100%', minHeight: '100px', fontSize: '1rem', padding: '1rem', background: 'transparent', border: '1px solid var(--glass-border)', borderRadius: '8px', color: 'var(--text-primary)', outline: 'none', resize: 'vertical', fontFamily: 'inherit', boxSizing: 'border-box' }}
          />
        </div>
