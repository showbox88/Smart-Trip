...
### 1. 沉浸式行程时间轴
- **垂直虚线时间线**：Wanderlog 风格的连续时间轴，精准串联起每一天的行程。
- **地标编号图标**：水滴形地标 Pin（灰蓝底，白色顺序编号），与地图上的标记视觉统一。
- **微缩全能卡片**：每个目的地独享毛玻璃效果卡片，包含动态小图、标签化的时间/价格、地址/联系电话。
- **拖拽排序**：支持拖拽重排时间线卡片，局部 DOM 更新避免页面闪烁。
...
- **实时标记落点**：右侧宽屏展示 Google 地图，随行程增加动态打上带顺序编号的 Marker。
...
---
*Created with ♥ by Antigravity AI Assistant. Updated 2026-02-27.*
