...
window.showInlineSearchAt = function (dayId, afterStopId) {
    ...
    container.style.cssText = 'position:relative; margin-bottom:0.5rem; margin-left:-3rem; padding-left:1rem; padding-right:2.5rem; display:flex; align-items:center; gap:0.5rem; z-index:20;';
    container.innerHTML = `
